...
function () {
    ...
    function getPlaneWorkByTime(startTime, endTime) {
        if (calendarYearChart != null) {
            planeDataMain.GetInfoByTime(startTime, endTime, setCalendar);
        }
    }

    

    function setCalendar(dataArray) {
        /// <summary>函数名</summary>     
        /// <param name="dataArray" type="obj">数组</param>        
    ...
    initNullCalendarFromYear(2005);
    getPlaneWorkByTime("2005-01-01", "2018-06-19");
